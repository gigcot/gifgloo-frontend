    ...
    >
      ...
      <section className="mt-8 border-t border-white/10 pt-8">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>GIF 이미지 합성 1회에는 10크레딧이 사용됩니다.</li>
          <li>50크레딧 상품은 6,600원이며, 현재 GIF 이미지 합성 기준 최대 5회 이용할 수 있습니다.</li>
      ...
      <section className="mt-8 border-t border-white/10 pt-8">
        ...
        <p className="mt-3">
          서비스 품질 개선을 위해 AI 모델 또는 처리 방식이 변경될 수 있습니다. 이용 가격, 필요 크레딧 또는 작업 기간에 영향을 주는 변경 사항은 해당 서비스 화면과 정책을 통해 안내합니다.
          AI 비디오 합성 등 신규 서비스는 별도의 이용 조건을 안내합니다.
        </p>
      </section>

      <p className="mt-8 text-xs text-white/35">
        결제 전 <Link href="/credits-policy" className="underline hover:text-white">크레딧 정책</Link>과 <Link href="/refund" className="underline hover:text-white">결제 및 환불정책</Link>을 확인해주세요.
      </p>
    </PolicyPage>
  );
}
